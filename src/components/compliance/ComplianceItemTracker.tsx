...
export function ComplianceItemTracker({ items }: ComplianceItemTrackerProps) {
  ...
  return (
    <>
      <div className="bg-white backdrop-blur-xl rounded-2xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden flex flex-col">
                  ...
                  >
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3.5">
                        <img src={item.caregiver.avatarUrl} alt={item.caregiver.name} className="w-9 h-9 rounded-full object-cover bg-slate-100 ring-2 ring-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]" />
                        <div>
            ...
            >
              ...
              <div className="p-4 flex-1 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <img src={selectedItem.caregiver.avatarUrl} alt={selectedItem.caregiver.name} className="w-12 h-12 rounded-full object-cover bg-slate-100" />
                  <div>
