...
export function CaregiverRoster({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden bg-white border-r border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)]">
                  ...
                  >
                    {isActive && (
                      <motion.div
                        layoutId="roster-tab"
                        className={clsx(
                          "absolute inset-0 rounded-md -z-10 shadow-[0_6px_32px_rgba(0,0,0,0.06)]",
      ...
      <button
        ...
        className="absolute top-1/2 -translate-y-1/2 -right-3 bg-white border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] rounded-full w-6 h-6 flex items-center justify-center text-slate-500 hover:text-brand-teal transition-colors z-50"
      >
