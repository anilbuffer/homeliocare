  ...
  return (
    <div className="bg-white backdrop-blur-xl rounded-2xl border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:border-brand-teal/60 transition-all duration-300 relative overflow-hidden h-full flex flex-col">
      <div className="flex items-center justify-between mb-4 p-4 border-b border-border-subtle">
        <h3 className="text-base font-medium text-text-primary">Recent Supervisor Home Visits</h3>
        <button
      ...
      <div className="space-y-4 flex-1 overflow-y-auto mx-4 my-2 pr-2 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-100/50 [&::-webkit-scrollbar-thumb]:rounded-full">
        {/* Sample Eval 1 */}
      ...
      >
        <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
          {/* We just duplicate the existing ones to demonstrate the list */}
          <div className="p-4 rounded-xl border border-border-subtle bg-slate-50/50 hover:border-border-subtle transition-colors">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <Avatar fallback="M" className="w-10 h-10 rounded-full bg-slate-100" />
