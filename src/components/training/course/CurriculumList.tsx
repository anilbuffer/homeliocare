          ...
          return (
            <div key={module.id} className="flex flex-col group/module">
              <button
                ...
                className={`w-full flex items-center justify-between p-6 transition-all duration-300 text-left ${isExpanded ? 'bg-slate-50' : 'hover:bg-slate-50/80'}`}
              >
              ...
              >
                <div className="overflow-hidden">
                  <div className="bg-slate-50/50 pb-8 px-6 pt-2">
                    <div className="relative border-l-2 border-slate-200 ml-[1.15rem] space-y-4">
        ...
        <div className="p-6 bg-slate-50/50 border-t border-slate-100">
          <div className="flex flex-col bg-white rounded-xl border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.06)] transition-all overflow-hidden group/quiz">
            <div
              ...
              className={`flex items-center justify-between px-6 py-5 transition-all ${progress?.quizPassed ? 'cursor-pointer hover:bg-slate-50/50' : ''}`}
            >
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h4 className={`font-bold text-lg transition-colors ${isPreviousCompleted ? 'text-slate-800 group-hover/quiz:text-brand-teal' : 'text-slate-400'}`}>
                    {course.quiz.title}
                  </h4>
