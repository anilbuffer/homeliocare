  ...
  return (
    <div className="space-y-4 mb-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-lg font-bold text-slate-900 tracking-tight">Billing & Claims Workspace</h1>
          <p className="text-xs text-slate-500 mt-1">Track revenue, resolve denials, and keep AR moving.</p>
        </div>
      ...
      <div className="flex items-center p-1.5 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.06)] rounded-2xl overflow-x-auto border border-slate-200 w-full sm:w-max max-w-full">
        <Link
          href="/billing"
          className={`relative px-4 py-2.5 text-sm font-semibold transition-colors whitespace-nowrap rounded-xl flex items-center gap-2 ${pathname === "/billing" ? "text-brand-teal" : "text-slate-500 hover:text-slate-800 hover:bg-slate-200/50"
            }`}
        >
        ...
        <Link
          href="/billing/claims"
          className={`relative px-4 py-2.5 text-sm font-semibold transition-colors whitespace-nowrap rounded-xl flex items-center gap-2 ${pathname === "/billing/claims" ? "text-brand-teal" : "text-slate-500 hover:text-slate-800 hover:bg-slate-200/50"
            }`}
        >
          <span className="relative z-10 flex items-center gap-2">
        ...
        <Link
          ...
          className={`relative px-4 py-2.5 text-sm font-semibold transition-colors whitespace-nowrap rounded-xl flex items-center gap-2 ${pathname === "/billing/private-pay" ? "text-brand-teal" : "text-slate-500 hover:text-slate-800 hover:bg-slate-200/50"
            }`}
        >
          <span className="relative z-10 flex items-center gap-2">
