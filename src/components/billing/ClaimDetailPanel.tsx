      ...
      <div className="fixed inset-0 z-50 flex justify-end">
        ...
        >
          <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <div>
              <h2 className="text-base font-semibold text-slate-900">Claim Details</h2>
              <p className="text-xs text-slate-500 mt-0.5">{claimId}</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-200 [&::-webkit-scrollbar-thumb]:rounded-full">
            ...
            {/* Claim Summary */}
            <div>
              <div className="text-xs font-medium text-slate-400 mb-2">Claim Summary</div>
            ...
            {/* Codes & Auth */}
            <div>
              <div className="text-xs font-medium text-slate-400 mb-2">Codes & Authorization</div>
              <div className="space-y-2">
                <div className="flex justify-between items-center py-2 border-b border-slate-100">
                  <span className="text-xs text-slate-500">Service Code (CPT)</span>
                  <span className="text-xs font-medium text-slate-900">T1019 (Personal Care)</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-100">
                  <span className="text-xs text-slate-500">Diagnosis Code (ICD-10)</span>
                  <span className="text-xs font-medium text-slate-900">G30.9 (Alzheimer's)</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-100">
                  <span className="text-xs text-slate-500">Authorization Ref</span>
                  <span className="text-xs font-medium text-brand-teal cursor-pointer hover:underline">AUTH-88291A</span>
                </div>
              </div>
            </div>
            ...
            {/* Documents */}
            <div>
              <div className="text-xs font-medium text-slate-400 mb-2">Attached Documents</div>
              <div className="space-y-2">
          ...
          <div className="px-4 py-3 border-t border-slate-100 bg-slate-50/50 flex gap-3">
