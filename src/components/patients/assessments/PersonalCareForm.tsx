    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
        ...
        >
          ...
          {!submitted && (
            <div className="p-4 md:p-6 border-t border-slate-100 bg-white flex items-center justify-between">
              <div className="text-sm font-medium text-slate-500">
                Step {step} of 2
              </div>
              <div className="flex items-center gap-3">
                {step === 2 && (
                  <button onClick={() => setStep(1)} className="px-4 py-2.5 text-sm font-semibold text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors">
                    Back
                  </button>
                )}
                {step === 1 ? (
                  <button onClick={() => setStep(2)} className="px-4 py-2.5 text-sm font-semibold text-white bg-brand-teal hover:bg-teal-700 rounded-xl transition-colors shadow-[0_6px_32px_rgba(0,0,0,0.06)]">
                    Next Step
                  </button>
                ) : (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-brand-teal hover:bg-teal-700 rounded-xl transition-colors shadow-[0_6px_32px_rgba(0,0,0,0.06)] disabled:opacity-70 disabled:cursor-not-allowed"
                  >
