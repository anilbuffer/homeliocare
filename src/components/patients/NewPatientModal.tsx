...
export function NewPatientModal({ isOpen, onClose }: NewPatientModalProps) {
  ...
  return (
      ...
      footer={
        <>
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-brand-teal rounded-xl hover:bg-brand-teal/90 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
          >
    ...
    >
      <form id="new-patient-form" onSubmit={handleSubmit} className="space-y-3">
