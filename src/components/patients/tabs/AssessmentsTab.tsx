        ...
        <Card className="p-6">
          ...
          <div className="relative pl-6 border-l-2 border-slate-100 space-y-6">
            <div className="relative">
              ...
              <div className="text-sm text-slate-500 mt-0.5 flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <button className="mt-3 text-xs font-semibold text-brand-teal hover:text-teal-700">Schedule Now</button>
            </div>
          </div>
        </Card>
      </div>
