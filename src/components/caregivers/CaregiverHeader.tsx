  ...
  return (
    <div className="bg-white rounded-2xl p-4 shadow-[0_6px_32px_rgba(0,0,0,0.06)] border border-slate-200 mb-4 flex flex-col md:flex-row md:items-start justify-between gap-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <div className="relative group cursor-pointer" onClick={onChangeStatus} title="Click to Change Status">
          ...
          <div className="absolute -bottom-2 -right-2">
            <Badge variant={
              ...
              "border-2 border-white shadow-md font-bold text-white px-3 py-1 cursor-pointer transition-transform group-hover:scale-105",
        ...
        <div>
          <h1 className="text-xl font-bold text-text-primary mb-2">{caregiver.name}</h1>
      ...
      <div className="flex flex-col items-start md:items-end gap-4 mt-4 md:mt-0">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="p-2 bg-white border border-slate-200 hover:bg-slate-50 active:scale-95 transition-all text-slate-700 rounded-xl shadow-[0_6px_32px_rgba(0,0,0,0.06)]"
            title="Edit Profile"
          >
