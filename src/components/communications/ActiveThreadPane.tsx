  ...
  if (isCreatingNew) {
    ...
    return (
      <div className="flex-1 flex flex-col h-full bg-[#f8fafd] min-w-0 relative">
        <div className="h-12 flex items-center px-3 lg:px-6 border-b border-slate-200/50 bg-[#fcfdfd]/80 backdrop-blur-md sticky top-0 z-20 shrink-0">
          {onBack && (
            <button
              onClick={onBack}
              className="lg:hidden p-1.5 mr-2 text-slate-500 bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:text-brand-teal rounded-full transition-colors"
            >
              <ChevronLeft className="w-4 h-4" />
            </button>
          )}
          <h2 className="font-semibold text-slate-900 text-base">New Message</h2>
        </div>
        <div className="flex-1 overflow-y-auto p-4 lg:p-8 custom-scrollbar">
          <div className="max-w-2xl mx-auto bg-white rounded-xl lg:rounded-2xl border border-slate-200/60 shadow-[0_8px_30px_-6px_rgba(0,0,0,0.06)] p-3 lg:p-6 space-y-4">
                ...
                {selectedRecipient ? (
                  ...
                  <>
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/20 focus:border-brand-teal transition-all placeholder:text-slate-400"
                    />
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/20 focus:border-brand-teal transition-all resize-none placeholder:text-slate-400"
              />
            </div>
            <div className="flex justify-end pt-2">
              <button className="px-3 py-2 text-sm bg-brand-teal text-white font-medium rounded-xl shadow-[0_8px_30px_-6px_rgba(20,184,166,0.3)] hover:shadow-[0_12px_40px_-6px_rgba(20,184,166,0.4)] hover:-translate-y-0.5 transition-all flex items-center gap-2">
      ...
      <div className="h-14 flex items-center justify-between px-2 lg:px-4 border-b border-slate-200/50 bg-[#fcfdfd]/80 backdrop-blur-md sticky top-0 z-20 shrink-0">
        <div className="flex items-center gap-2 lg:gap-4">
          {onBack && (
            <button
              onClick={onBack}
              className="lg:hidden p-2 mr-2 text-slate-500 bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:text-brand-teal rounded-full transition-colors"
            >
              <ChevronLeft className="w-4 h-4" />
            </button>
          )}
