    ...
    <div className="flex h-full overflow-hidden bg-white/50 backdrop-blur-xl rounded-2xl border border-white/60 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.1)] relative">
      ...
      {activeCategory !== "Announcements" && (
        <div className={clsx(
          ...
          mobileView === "details" ? "fixed inset-0 w-full h-full block" : "hidden",
          "lg:static lg:block lg:h-full lg:inset-auto",
          showDetails ? "lg:w-[320px] xl:w-[380px] border-l border-slate-200" : "lg:w-0 border-l-0 overflow-hidden"
        )}>
