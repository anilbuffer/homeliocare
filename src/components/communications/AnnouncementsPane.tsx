  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 min-w-0">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {isComposing ? (
          <div className="max-w-2xl mx-auto bg-white rounded-xl border border-slate-200 shadow-sm p-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {mockAnnouncements.map(announcement => (
              <div key={announcement.id} className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
