...
export const MOCK_COURSES: Course[] = [
  ...
  { id: "c12", title: "Patient Rights & Dignity", category: "Patient Rights", format: "Reading", duration: "30m", required: true, thumbnailColor: "bg-accent-purple", passRate: 80, attemptsAllowed: 3, assignedCount: 50, completionRate: 88 },
