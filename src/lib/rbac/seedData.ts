...
export const SEED_USERS: User[] = [
  ...
  },
  {
    ...
    role_id: "scheduler_dispatcher",
    status: "active",
    branch_id: "branch-central",
    assigned_clients: null,
    assigned_caregivers: null,
    last_login_at: "Today, 6:00 AM",
    mfa_enabled: true,
    invited_by: "sarah@homeliocare.com",
    invited_at: "2026-01-15T08:00:00Z",
    linked_client_ids: null,
  },
  {
    ...
    role_id: "caregiver_field",
    status: "active",
    branch_id: "branch-central",
    assigned_clients: null,
    assigned_caregivers: null,
    last_login_at: "Today, 7:30 AM",
    mfa_enabled: true,
    invited_by: "sarah@homeliocare.com",
    invited_at: "2026-01-15T08:00:00Z",
    linked_client_ids: null,
  ...
  },
  {
    ...
    role_id: "portal_client",
    status: "active",
    branch_id: null,
    assigned_clients: null,
    assigned_caregivers: null,
    last_login_at: "Today, 9:00 AM",
    mfa_enabled: false,
    invited_by: "sarah@homeliocare.com",
    invited_at: "2026-01-15T08:00:00Z",
    linked_client_ids: ["cli-101"],
