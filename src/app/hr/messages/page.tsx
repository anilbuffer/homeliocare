...
export default function HrMessagesPage() {
  return (
    ...
    >
      {/* Premium Header */}
      <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.03)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
        <div>
          <div className="flex items-center gap-2.5">
            <MessageSquare className="w-6 h-6 text-brand-teal" />
            <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">HR Candidate & Caregiver Communications</h1>
          </div>
        ...
        <div className="bg-brand-teal/10 text-brand-teal text-xs font-bold px-3.5 py-1.5 rounded-full border border-brand-teal/20 flex items-center gap-1.5 self-start sm:self-auto shadow-2xs shrink-0">
