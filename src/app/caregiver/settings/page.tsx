                ...
                <div className="space-y-4">
                  <div className="p-4 gap-3 rounded-xl border border-slate-200 bg-gray-50/50 space-y-3">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <span className="text-[11px] text-gray-500 lh-0.6 inline-block">High accuracy uses combined Wi-Fi, Cell Tower & GPS sensors for state matrix verification.</span>
                      </div>
                      <select
                        value={gpsAccuracy}
                  ...
                  <div className="p-4 gap-3 rounded-xl border border-slate-200 bg-gray-50/50 space-y-3">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <span className="text-[11px] text-gray-500 lh-0.6 inline-block">Maximum distance allowed from client coordinates to clock in without manual FVV exception log.</span>
                      </div>
                      <select
                  ...
                  <div className="p-4 rounded-xl border border-slate-200 bg-gray-50/50 flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-[11px] text-gray-500 lh-0.6 inline-block">Automatically sync pending offline visit logs as soon as Wi-Fi or LTE connection is restored.</span>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <div className="p-4 gap-3 rounded-xl border border-slate-200 bg-gray-50/50 space-y-3">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <span className="text-[11px] text-gray-500 lh-0.6 inline-block">4-digit PIN for rapid clock-in unlocking on field devices.</span>
                      </div>
                      <input
                        type="password"
                        maxLength={4}
