      ...
      <div className="max-w-full mx-auto space-y-6">
        ...
        <Card noPadding className="flex flex-col">
          <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between bg-slate-100">
            <h3 className="font-semibold text-slate-900">Pay Period Reconciliation</h3>
          </div>
        ...
        {isExportOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-lg z-[101] overflow-hidden border border-slate-100"
            >
              {exportComplete ? (
                <div className="p-4 text-center space-y-3">
                  ...
                  <h2 className="text-lg font-semibold text-slate-900">Export Complete</h2>
                ...
                <>
                  <div className="px-4 py-2 border-b border-slate-100 flex items-center justify-between">
                    <div>
                      <h2 className="text-lg font-semibold text-slate-900">Export Payroll</h2>
                      <p className="text-xs text-slate-500 mt-1">Select your payroll provider mapping</p>
                    </div>
                    <button
                  ...
                  <div className="p-4 space-y-3">
                    {[
                      ...
                      <button
                        ...
                        disabled={exporting}
                        className={clsx(
                          "w-full text-left px-4 py-3 rounded-xl border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] transition-all flex items-center justify-between",
                  ...
                  <div className="p-4 bg-slate-50 border-t border-slate-100">
                    <button
                      ...
                      className="w-full py-3 px-4 bg-brand-teal hover:bg-brand-teal/90 disabled:opacity-50 disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-medium rounded-xl flex items-center justify-center gap-2 transition-all shadow-[0_6px_32px_rgba(0,0,0,0.06)] shadow-brand-teal/20"
                    >
        ...
        {isRulesOpen && (
          <>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-2xl shadow-2xl z-[101] overflow-hidden border border-slate-200"
            >
              <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                <div>
                  <h2 className="text-base font-semibold text-slate-900">Rule Configuration</h2>
                  <p className="text-xs text-slate-500">Manage state-specific overtime and penalty rules</p>
                </div>
                <button
                  onClick={() => setIsRulesOpen(false)}
              ...
              <div className="p-4 space-y-3">
                <div className="space-y-2">
                  <h3 className="text-sm font-semibold text-slate-700">California Overtime Rules</h3>
                  <div className="flex items-center justify-between px-4 py-3 rounded-xl border border-slate-200 bg-white">
                    <div>
                      <div className="font-semibold text-slate-900 text-sm">Daily Overtime (&gt;8 hours)</div>
                  ...
                  <div className="flex items-center justify-between px-4 py-3 rounded-xl border border-slate-200 bg-white">
                    <div>
                      <div className="font-semibold text-slate-900 text-sm">Daily Double Time (&gt;12 hours)</div>
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-semibold text-slate-700">Shift Differentials</h3>
                  <div className="flex items-center justify-between p-4 rounded-xl border border-slate-100 bg-white">
                    <div>
                      <div className="text-sm font-semibold text-slate-900">Weekend Premium</div>
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-200 flex justify-end gap-3">
                <button
                  onClick={() => setIsRulesOpen(false)}
                  className="px-4 py-2 rounded-xl text-sm font-medium text-slate-600 bg-white border border-slate-200 hover:bg-slate-200 transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={() => setIsRulesOpen(false)}
                  className="px-4 py-2 rounded-xl text-sm font-medium text-white bg-brand-teal hover:bg-brand-teal/90 shadow-[0_6px_32px_rgba(0,0,0,0.06)] shadow-brand-teal/20 transition-all"
                >
                  Save Configuration
                </button>
              </div>
